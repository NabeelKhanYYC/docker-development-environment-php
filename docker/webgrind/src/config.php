...
class Webgrind_Config extends Webgrind_MasterConfig {
     ...
     */
    static $storageDir = '/opt/webgrind/';
    static $profilerDir = '/opt/xdebug/output/';
    ...
    static $defaultTimezone = 'America/Edmonton';
    ...
    static function exposeServerFile($file) {
        ...
        $prefixes = ['/opt/project/', '/var/www/html/'];
        foreach($prefixes as $prefix) {
            $file = realpath($prefix . $file);
